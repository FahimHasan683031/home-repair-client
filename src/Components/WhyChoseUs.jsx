    ...
    return (
        <div className="max-w-screen-xl px-6 mx-auto mb-32 grid grid-cols-1  lg:grid-cols-2 gap-4">
            ...
            <div  className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="p-4 border-[4px] border-teal-10">
                    <h1 className="text-3xl font-bold text-teal-600 my-3">01.</h1>
                ...
                <div className="p-4 border-[4px] border-teal-10">
                    <h1 className="text-3xl font-bold text-teal-600 my-3">02.</h1>
                ...
                <div className="p-4 border-[4px] border-teal-10">
                    <h1 className="text-3xl font-bold text-teal-600 my-3">03.</h1>
                ...
                <div className="p-4 border-[4px] border-teal-10">
                    <h1 className="text-3xl font-bold text-teal-600 my-3">04.</h1>
