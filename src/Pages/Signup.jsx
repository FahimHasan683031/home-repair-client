        ...
        <div>
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col w-full md:w-4/6 lg:w-1/3">
                    ...
                    <div className=" flex-shrink-0 w-full max-w-sm bg-purple-200 shadow-xl ">
                        <form onSubmit={registerHandle} className=" px-6 pt-4 pb-6 text-sm ">
                            <h1 className="text-4xl text-purple-700 pt-3 font-bold text-center mb-4">Register now</h1>
                            ...
                            <div className="form-control mt-4">
                                <button type="submit" className="py-3 text-white font-bold bg-purple-700">Register</button>
                            </div>
